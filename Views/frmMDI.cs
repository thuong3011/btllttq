...
namespace ShoeStore.Views
{
    public partial class frmMDI : Form
    {
        ...
        {
            if (this.formDoanhThu is null || this.formDoanhThu.IsDisposed)
            {
                this.formDoanhThu = new frmDoanhThu();
                this.formDoanhThu.MdiParent = this;
                this.formDoanhThu.Dock = DockStyle.Fill;
                this.formDoanhThu.Show();
            }
            else
            {
                this.formDoanhThu.Select();
            }
        }
