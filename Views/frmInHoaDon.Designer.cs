namespace ShoeStore.Views
{
    partial class frmInHoaDon
    {
        ...
        private void InitializeComponent()
        {
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.loadlai);
			...
			// btnHuy
			// 
			this.btnHuy.Location = new System.Drawing.Point(723, 16);
			this.btnHuy.Name = "btnHuy";
			this.btnHuy.Size = new System.Drawing.Size(54, 40);
			...
			// btnThanhToan
			// 
			this.btnThanhToan.Location = new System.Drawing.Point(531, 16);
			...
			this.lblSoLuongTrongKho.Click += new System.EventHandler(this.lblSoLuongTrongKho_Click);
			// 
			// lblGiaBan
			// 
			...
			// loadlai
			// 
			this.loadlai.Location = new System.Drawing.Point(626, 19);
			this.loadlai.Name = "loadlai";
			this.loadlai.Size = new System.Drawing.Size(75, 37);
			this.loadlai.TabIndex = 29;
			this.loadlai.Text = "Load lại";
			this.loadlai.UseVisualStyleBackColor = true;
			this.loadlai.Click += new System.EventHandler(this.loadlai_Click);
			// 
			// frmInHoaDon
			// 
